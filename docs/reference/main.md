...
- `docs/reference/classifier.md` — Classification algorithm and decisions
- `docs/reference/aggregator.md` — Aggregation rules and examples
- `docs/reference/analysis.md` — Visualization & metrics
